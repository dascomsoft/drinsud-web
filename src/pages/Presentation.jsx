...
const Presentation = () => {
  ...
  const missions = [
    "Concrétiser les projets de la diaspora dans le pays d'origine et offrir des prestations diverses afin d'encourager son investissement ;",
    "Contribuer à l'efficacité des politiques publiques nationales et locales en matière de codéveloppement, Action internationales des collectivités territoriales et de coopération décentralisée, planification stratégique et gestion de projets dans le cadre d'études et activités spécifiques ;",
    "Accompagner le gouvernement et les CTD dans la conception et la mise en œuvre des stratégies de mobilisation de la diaspora et stratégies d'internationalisation ;",
    "Contribuer à la lutte contre l'immigration clandestine à travers la promotion de l'entrepreneuriat jeune, l'investissement et le placement international de la main d'œuvre locale ;",
    "Promouvoir la migration circulaire et le transfert de savoirs entre la diaspora et les organisations locales, etc. ;",
    ...
    "Fournir des solutions digitales aux organisations"
  ];

  const actions = [
    "Montage, gestion et réalisation des projets divers et investissements de la diaspora (projet immobilier, projet d'investissement, projet foncier, projets sociaux, projet évènementiel, projet de séjour ou de retour) ;",
    ...
    "Montage et gestion de Projet de codéveloppement et de coopération décentralisée et d'AICT ;",
    "Conception et mise en œuvre de l'action internationale des CTD (stratégie de codéveloppement, stratégie de coopération décentralisée, stratégie de marketing territorial, Agenda 21 local) ;",
    "Recherche de financement pour les projets de développement ;",
